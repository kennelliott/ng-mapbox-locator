...
class GraphicsDeployer {
    ...
    successMessage() {
        ...
        console.log(chalk.magenta(`\u0020* Publishing checklist: https://docs.google.com/document/d/1c734ZEgYKZbE6BIoDhChHoFOFBpMucqqjPiwWKItaGM/`))
        console.log(chalk.white.bgMagenta("\u0020⚠️\u0020\u0020Please run `trudy archive` and push your project to Github\u0020⚠️\u0020\u0020\u0020"))
        console.log(chalk.magenta(sep))
        console.log('\r')
